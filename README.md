...
8. Confirm the deployed web app URL in `APPS_SCRIPT_URL` in `script.js` is current. The current URL is `https://script.google.com/macros/s/AKfycbxl_K3tapX4Zn4GiyNvh9-O_nrb7PfvZQJYZvdfs9-urFYu1TF92D80_E2RyvDIzscN/exec`.
