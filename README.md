...
8. Confirm the deployed web app URL in `APPS_SCRIPT_URL` in `script.js` is current. The current URL is `https://script.google.com/macros/s/AKfycbzkCO5hSW4FvDNbDvCkyMjh2u-UK1K67_BKJZKLqRqbgEuaD5NbqWzX3VHSuqMhU8mw/exec`.
