...
7. Confirm the deployed web app URL in `APPS_SCRIPT_URL` in `script.js` is current. The current URL is `https://script.google.com/macros/s/AKfycbzLuaYF978bs_JlUuOi8dBifVr90blIZBE2pMddG-Ug0BraaA6ZwiKrWY964N45lH6d/exec`.
