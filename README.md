...
7. Confirm the deployed web app URL in `APPS_SCRIPT_URL` in `script.js` is current. The current URL is `https://script.google.com/macros/s/AKfycbw9p_blBynP8RO8VAUj8_lHUUBgQ4WffwxSCz2ehJ7FT3nYy4GGVcwanHRpiBneUkUt/exec`.
