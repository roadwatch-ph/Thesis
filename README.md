...
8. Confirm the deployed web app URL in `APPS_SCRIPT_URL` in `script.js` is current. The current URL is `https://script.google.com/macros/s/AKfycbwW-2P2bv1UWHAtZh5Nsc7dWquV4MUPyATiJNfztt0SjS2-oYM_b7LP1mWhA9dKpoTk/exec`.
