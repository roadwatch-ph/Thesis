...
7. Confirm the deployed web app URL in `APPS_SCRIPT_URL` in `script.js` is current. The current URL is `https://script.google.com/macros/s/AKfycbxuxxKfKL4Y7qdaPFVQZFu_cWjyeXpvjAuh9UYuIAbvjZDfI8meYGAgMc5GLNgSMETv/exec`.
